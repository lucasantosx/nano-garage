...
Desenvolver uma aplicação web responsiva para colecionadores de miniaturas 1/64, permitindo a consulta a um catálogo de modelos e o gerenciamento de uma coleção física personalizada, com funcionalidades de cadastro,
categorização por niveis de raridade (Mainline, STH, Premium) e organização por lotes anuais.
